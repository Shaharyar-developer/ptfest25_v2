              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "hover:before:bg-neutral-200 dark:hover:before:bg-neutral-800 hover:before:opacity-100 hover:before:duration-0 dark:hover:after:bg-neutral-900 hover:after:bg-primary/50 hover:after:opacity-100 hover:after:duration-0 trnasition-all",
